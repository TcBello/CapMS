...
const OtherProfile = () => {
    ...
    return (
        <IonPage>
            {/* APP BAR */}
            <MobileArrowBackAppBar href="Split-view-admin" title="Students Profile" />
            <IonContent className={isDesktop ? "profile-content" : "profile-content-mpbile"}>
                {
                    ...
                    // DESKTOP VIEW
                        ...
                        : <div className="profile-mobile-container">
                            ...
                            <IonButton className="edit-button-mobile" shape="round" href="/home/admin/students/profile/edit">Edit Profile</IonButton>
                        </div>
                }
            </IonContent>
        </IonPage>
