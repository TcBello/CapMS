...
class LoginWeb1 extends Component<{}, {email: string, password: string}>{
    constructor(props: {}){
        super(props);
        this.state = {
            email: "",
    ...
    Login(){
        var user = sampleData.find(users => users.email == this.state.email);
        if(user){
                        ...
                        <IonCard className="card">
                            ...
                            <div className="input-field-container">
                                ...
                                <IonItem lines="none" className="input-field">
                                    ...
                                    <IonInput value={this.state.email} onIonChange={(e: any) => {
                                        this.setState({
                            ...
                            <div className="input-field-container">
                                ...
                                <IonItem lines="none" className="input-field">
                                    ...
                                    <IonInput type="password" value={this.state.password} onIonChange={(e: any) => {
                                        this.setState({
                            ...
                            {/* LOGIN BUTTON */}
                            <IonButton className="login-button" onClick={this.Login}>LOGIN</IonButton>
                        </IonCard>
                    </div>
                </MediaQuery>
            </div>
